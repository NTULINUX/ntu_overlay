...
src_install() {
	...
	doicon "${S_TOP}/debian/extras/usr/share/icons/hicolor/scalable/apps/linuxcnc-logo.svg"
	doicon "${S_TOP}/debian/extras/usr/share/icons/hicolor/scalable/apps/linuxcncicon.svg"
	domenu "${S_TOP}/share/applications/linuxcnc-latency.desktop"
	domenu "${S_TOP}/share/applications/linuxcnc-latency-histogram.desktop"
	domenu "${S_TOP}/share/applications/linuxcnc-pncconf.desktop"
	domenu "${S_TOP}/share/applications/linuxcnc-stepconf.desktop"
	domenu "${S_TOP}/share/applications/linuxcnc.desktop"

	# Do not compress documentation, .ini files need to be readily accessible
	docompress -x "/usr/share/doc/linuxcnc/examples"

	# Force install of nc_files directory to fix broken symlink
	cp -aL "${S_TOP}/nc_files" "${D}/usr/share/doc/linuxcnc/examples/"
}
